...
class User {
 public:
  ...
  /**
   * Gets all the tweets this user was mentioned in
   * 
   * @return List of tweets this user was mentioned in
   */
  //std::list<Tweet*> mentweets() const; 
  ...
  void addMentionedTweet(Tweet* t);
 ...
 private:
  ...
  std::list<Tweet*> mentioned;
  std::list<Tweet*> mention;
};
